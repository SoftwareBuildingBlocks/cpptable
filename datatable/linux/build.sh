...
clang++ -g -O0 -std=c++1y -D GTEST_HAS_TR1_TUPLE=0 -c -I ../include ../test/expr_compiler_test.cpp ../test/simple_data_row.cpp ../test/test_data.cpp
...
## compile data_table test source files
clang++ -g -O0 -std=c++1y -D GTEST_HAS_TR1_TUPLE=0 -c -I ../include ../test/data_table_tests.cpp ../test/test_main.cpp
